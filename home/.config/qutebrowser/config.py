...
c.colors.completion.fg = [p[7], p[6], p[9]]
...
c.colors.completion.item.selected.match.fg = p[9]
c.colors.completion.match.fg = p[13]
...
c.colors.downloads.start.bg = p[9]
c.colors.downloads.stop.fg = p[0]
c.colors.downloads.stop.bg = p[10]
c.colors.downloads.error.fg = p[0]
c.colors.downloads.error.bg = p[15]

c.colors.hints.bg = p[13]
c.colors.hints.fg = p[0]
c.colors.hints.match.fg = p[6]

c.colors.keyhint.bg = p[0]
c.colors.keyhint.fg = p[7]
c.colors.keyhint.suffix.fg = p[9]

c.colors.messages.error.bg = p[15]
c.colors.messages.error.border = p[15]
c.colors.messages.error.fg = p[0]
c.colors.messages.info.bg = p[10]
c.colors.messages.info.border = p[10]
c.colors.messages.info.fg = p[0]
c.colors.messages.warning.bg = p[9]
c.colors.messages.warning.border = p[9]
...
c.colors.statusbar.url.error.fg = p[15]
c.colors.statusbar.url.fg = p[7]
c.colors.statusbar.url.hover.fg = p[13]
c.colors.statusbar.url.success.http.fg = p[7]
c.colors.statusbar.url.success.https.fg = p[10]
c.colors.statusbar.url.warn.fg = p[9]

c.colors.tabs.bar.bg = p[1]
c.colors.tabs.even.bg = p[0]
c.colors.tabs.even.fg = p[6]
c.colors.tabs.indicator.error = p[15]
c.colors.tabs.indicator.start = p[9]
c.colors.tabs.indicator.stop = p[10]
...
c.qt.args = [
  'widevine-path=/usr/lib64/chromium-browser/WidevineCdm/'
