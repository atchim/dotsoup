...
local lazy_spec = {{"neovim/nvim-lspconfig", event = "BufRead", config = config, dependencies = {"williamboman/mason-lspconfig.nvim", config = true, dependencies = {"williamboman/mason.nvim", cmd = {"Mason", "MasonInstall", "MasonUninstall", "MasonUninstallAll", "MasonLog"}, config = true}}}, {"j-hui/fidget.nvim", event = "LspAttach", opts = {text = {spinner = "dots"}}, config = true}}
local function setup()
  ...
  do
    ...
    map("n", "<Leader>k", "<Cmd>lua vim.diagnostic.open_float()<CR>", {desc = "Diagnostic show from line"})
  end
